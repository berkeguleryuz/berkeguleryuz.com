...
const Services = (props: Props) => {
  return (
    <div id="services" className='w-10/12 mx-auto col-span-3'>
        ...
        <div className='flex max-md:flex-wrap gap-7 justify-between'>
            <div className='d w-full p-5 relative overflow-hidden mt-5'>
                <h1 className='text-center mt-5'>UI/UX Design & Web Development</h1>
                ...
                <p className='text-center  mt-10 mb-7'><a href="mailto:berkeguleryuz@hotmail.com" className='px-4 py-2 rounded-sm border-[0.5px] border-[#363636] shadow-md text-gray-400 hover:text-green-500'>know more</a></p>
            ...
            <div className='d w-full p-5 relative overflow-hidden mt-5'>
                <h1 className='text-center mt-5'>Community Management</h1>
                <div className='flex justify-center mt-4'>
                    <MdDeveloperMode className='text-blue-600' size={28}/>
                </div>
                <p className='text-center mt-10 text-neutral-300'><span className=' text-xl font-bold '>blockchain & social</span> management makes loyal community </p>
                <p className='text-center  mt-10 mb-7'><a href="mailto:berkeguleryuz@hotmail.com" className='px-4 py-2 rounded-sm border-[0.5px] border-[#363636] shadow-md text-gray-400 hover:text-green-500'>know more</a></p>
                <span className='w-[60px] h-[60px] z-[-2] blur-[100px] left-[45%] bg-white absolute top-0 '></span>
            ...
            <div className='d w-full p-5 relative overflow-hidden mt-5'>
                <h1 className='text-center mt-5'>Long-Term Partnership</h1>
                <div className='flex justify-center mt-4'>
                    <AiOutlineFieldTime className='text-yellow-500' size={28}/>
                </div>
                <p className='text-center mt-10 text-neutral-300'><span className=' text-xl font-bold '>know & how</span> improves your future vision</p>
                <p className='text-center  mt-10 mb-7'><a href="mailto:berkeguleryuz@hotmail.com" className='px-4 py-2 rounded-sm border-[0.5px] border-[#363636] shadow-md text-gray-400 hover:text-green-500'>know more</a></p>
                <span className='w-[60px] h-[60px] z-[-2] blur-[100px] left-[45%] bg-white absolute top-0 '></span>
